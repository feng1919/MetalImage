//
//  MetalImageBulgeDistortionFilter.m
//  MetalImage
//
...
@interface MetalImageBulgeDistortionFilter()
...
@implementation MetalImageBulgeDistortionFilter

- (id)init
{
    if (!(self = [super initWithFragmentFunctionName:@"fragment_BulgeDistortionFilter"]))
    {
        return nil;
    }
