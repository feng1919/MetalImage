...
@implementation MetalImageRGBErosionFilter
...
- (instancetype)initWithRadius:(MTLUInt)dilationRadius {
    ...
    NSString *fragmentFunctionName = [NSString stringWithFormat:@"fragment_RGBErosionFilterRadius%d", supportedDilationRadius];
