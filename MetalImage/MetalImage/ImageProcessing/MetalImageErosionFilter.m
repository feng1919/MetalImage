...
@implementation MetalImageErosionFilter
...
- (instancetype)initWithRadius:(MTLUInt)dilationRadius {
    ...
    NSString *fragmentFunctionName = [NSString stringWithFormat:@"fragment_ErosionFilterRadius%d", supportedDilationRadius];
