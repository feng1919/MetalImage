...
#import "MetalImageAlphaBlendFilter.h"
#import "MetalDevice.h"

@interface MetalImageAlphaBlendFilter()

@property (nonatomic, strong) id<MTLBuffer> buffer;

@end

@implementation MetalImageAlphaBlendFilter

- (id)init
{
    if (!(self = [super initWithFragmentFunctionName:@"fragment_alphaBlend"]))
    {
        return nil;
    }
