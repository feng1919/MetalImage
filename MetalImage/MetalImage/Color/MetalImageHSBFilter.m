...
#import "MetalImageHSBFilter.h"

@interface MetalImageHSBFilter() {
    float matrix[4][4];
}

@end

@implementation MetalImageHSBFilter
...
- (void)_updateColorMatrix {
    ...
    colorMatrix.v1.x = matrix[0][0];
    colorMatrix.v1.y = matrix[1][0];
    colorMatrix.v1.z = matrix[2][0];
    colorMatrix.v1.w = matrix[3][0];
    
    colorMatrix.v2.x = matrix[0][1];
    colorMatrix.v2.y = matrix[1][1];
    colorMatrix.v2.z = matrix[2][1];
    colorMatrix.v2.w = matrix[3][1];
    
    colorMatrix.v3.x = matrix[0][2];
    colorMatrix.v3.y = matrix[1][2];
    colorMatrix.v3.z = matrix[2][2];
    colorMatrix.v3.w = matrix[3][2];
    
    colorMatrix.v4.x = matrix[0][3];
    colorMatrix.v4.y = matrix[1][3];
    colorMatrix.v4.z = matrix[2][3];
    colorMatrix.v4.w = matrix[3][3];
